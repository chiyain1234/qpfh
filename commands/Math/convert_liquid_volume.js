...
module.exports = {
    data: new SlashCommandSubcommandBuilder()
        .setName('convert_liquid_volume')
        .setDescription('液体の体積単位変換を行います。')
        ...
        .addStringOption(option =>
            option.setName('from')
                  ...
                  .setRequired(true)
                  .addChoices([
                      { name: 'minim', value: 'minim' },
                      { name: 'fluid dram', value: 'fldr' },
                      { name: 'fluid ounce', value: 'floz' },
                      { name: 'gill', value: 'gi' },
                      { name: 'cup', value: 'cp' },
                      { name: 'pint', value: 'pt' },
                      { name: 'quart', value: 'qt' },
                      { name: 'gallon', value: 'gal' },
                      { name: 'beer barrel', value: 'bbl' },
                      { name: 'oil barrel', value: 'obl' },
                      { name: 'hogshead', value: 'hogshead' },
                      { name: 'drop', value: 'gtt' }
                  ])
        )
        .addStringOption(option =>
