...
module.exports = {
    ...
    data: new SlashCommandSubcommandBuilder()
        .setName(cmdName)
        .setDescription('アメリカンなアバターを作成します。')
    ...
    async execute(interaction, client) {
        try {
            ...
            const imagePath = path.join(__dirname, '../../Images', 'usa.png');
            ...
            // 画像をバッファに変換
            const attachment = new MessageAttachment(canvas.toBuffer(), 'usa.png');

            const embed = new MessageEmbed()
                .setColor(client.config.color)
                .setDescription(`_${user.username} is USA_`)
                .setImage('attachment://usa.png')
