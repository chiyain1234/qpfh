...
module.exports = {
    ...
    data: new SlashCommandSubcommandBuilder()
        .setName(cmdName)
        .setDescription('ブリティッシュなアバターを作成します。')
    ...
    async execute(interaction, client) {
        try {
            ...
            const imagePath = path.join(__dirname, '../../Images', 'uk.png');
            ...
            // 画像をバッファに変換
            const attachment = new MessageAttachment(canvas.toBuffer(), 'uk.png');

            const embed = new MessageEmbed()
                .setColor(client.config.color)
                .setDescription(`_${user.username} is UK_`)
                .setImage('attachment://uk.png')
