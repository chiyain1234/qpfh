...
module.exports = {
    ...
    data: new SlashCommandSubcommandBuilder()
        .setName(cmdName)
        .setDescription('トランスジェンダーの旗でアバターを作成します。')
    ...
    async execute(interaction, client) {
        try {
            ...
            const imagePath = path.join(__dirname, '../../Images', 'trans.png');
            ...
            // 画像をバッファに変換
            const attachment = new MessageAttachment(canvas.toBuffer(), 'trans.png');

            const embed = new MessageEmbed()
                .setColor(client.config.color)
                .setDescription(`_${user.username}_`)
                .setImage('attachment://trans.png')
