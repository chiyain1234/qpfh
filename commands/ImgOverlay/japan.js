...
module.exports = {
    ...
    data: new SlashCommandSubcommandBuilder()
        .setName(cmdName)
        .setDescription('ジャパニーズなアバターを作成します。')
    ...
    async execute(interaction, client) {
        try {
            ...
            const imagePath = path.join(__dirname, '../../Images', 'japan.png');
            ...
            // 画像をバッファに変換
            const attachment = new MessageAttachment(canvas.toBuffer(), 'japan.png');

            const embed = new MessageEmbed()
                .setColor(client.config.color)
                .setDescription(`_${user.username} is JAPAN_`)
                .setImage('attachment://japan.png')
