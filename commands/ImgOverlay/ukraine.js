...
module.exports = {
    ...
    data: new SlashCommandSubcommandBuilder()
        .setName(cmdName)
        .setDescription('指定したユーザーのアバターをウクライナにします。')
    ...
    async execute(interaction, client) {
        try {
            ...
            const imagePath = path.join(__dirname, '../../Images', 'ukraine.png');
            ...
            // 画像をバッファに変換
            const attachment = new MessageAttachment(canvas.toBuffer(), 'ukraine.png');

            const embed = new MessageEmbed()
                .setColor(client.config.color)
                .setDescription(`_${user.username} is Ukraine_`)
                .setImage('attachment://ukraine.png')
